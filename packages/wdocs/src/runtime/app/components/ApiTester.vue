...
<template>
  <div class="bg-gray-100 dark:bg-gray-800 rounded-lg p-6 my-8">
    ...
    <ApiTesterForm v-model:baseUrl="_baseUrl" v-model:authToken="_authToken" v-model:formValues="_formValues" :parameters="parameters" />

    <button @click="_testRequest" :disabled="_loading" class="mt-6 w-full bg-primary-500 text-white py-2 px-4 rounded-md hover:bg-primary-600 disabled:bg-gray-400 font-semibold transition-colors">

...
const { editPageUrl: _editPageUrl, lastUpdated: _lastUpdated } = usePageLifecycle(toRef(props, 'page'))
</script>

<template>
  <div class="mt-8 pt-8 border-t border-gray-200 dark:border-gray-700 text-sm">
    <div class="flex justify-between">
      <a v-if="_editPageUrl" :href="_editPageUrl" target="_blank" rel="noopener noreferrer" class="text-gray-500 dark:text-gray-400 hover:text-primary-500 dark:hover:text-primary-400 transition-colors">

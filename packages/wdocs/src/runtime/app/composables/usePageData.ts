...
export function usePageData(contents: Ref<PageContent[] | null | undefined>): { page: Ref<PageData | undefined>; editPageUrl: Ref<string | null>; lastUpdated: Ref<string | null> } {

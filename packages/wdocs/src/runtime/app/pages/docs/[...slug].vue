<template>
  ...
  <ContentProse v-if="_pageData">
    ...
    <template v-if="_frontmatter?.api && _frontmatter.method && _frontmatter.path">
      <ApiEndpoint :method="_frontmatter.method" :path="_frontmatter.path" :description="_frontmatter.description" />
      <ApiParameters v-if="_frontmatter.parameters" :parameters="_frontmatter.parameters" />
      <ApiResponses v-if="_frontmatter.responses" :responses="_frontmatter.responses" />
    </template>
